...
/**
 * Cette classe repr�sente une personne quelconque caract�ris�e par son nom, son
 * prenom, sa langue d'expression(par d�faut le Francais) et sa ville d'�tude.
 * 
 * @author Harold
 *
 */
public class Personne {
    ...
    /**
     * Ce constructeur initialise les param�tres ci-dessous
     * 
     * @param nom
     * @param prenom
     * @param ville
